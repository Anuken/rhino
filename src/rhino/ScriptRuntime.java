...
public class ScriptRuntime{
    ...
    public final static Class<?>
    ContextClass
    = Kit.classOrNull("rhino.Context"),
    ContextFactoryClass
    = Kit.classOrNull("rhino.ContextFactory"),
    FunctionClass
    = Kit.classOrNull("rhino.Function"),
    ScriptableObjectClass
    = Kit.classOrNull("rhino.ScriptableObject");
