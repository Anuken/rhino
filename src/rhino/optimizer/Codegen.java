...
*/
    ...
    static void pushUndefined(ClassFileWriter cfw){
        cfw.add(ByteCode.GETSTATIC, "rhino/Undefined",
...
class BodyCodegen{
    ...
    private void generateLocalYieldPoint(Node node, boolean exprContext){
        ...
        if(node.getType() == Token.YIELD_STAR){
            ...
            cfw.add(ByteCode.DUP_X1);
            cfw.add(ByteCode.SWAP);
            cfw.addInvoke(ByteCode.INVOKESPECIAL, "rhino/ES6Generator$YieldStarResult",
    ...
    private void generateArrayLiteralFactory(Node node, int count){
        ...
        argsLocal = firstFreeLocal++;
        localsMax = firstFreeLocal;
        cfw.startMethod(methodName, "(Lrhino/Context;"
        + "Lrhino/Scriptable;"
        + "Lrhino/Scriptable;"
        + "[Ljava/lang/Object;"
        + ")Lrhino/Scriptable;",
